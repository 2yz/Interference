...
#define ENEMY_CATEGORY_MASK 0x000000FF
#define ENEMY_CONTACT_MASK 0x000000FF
#define ENEMY_COLLISION_MASK 0x000000FF

#define BULLET_TAG -2
#define BULLET_GROUP -2
#define BULLET_CATEGORY_MASK 0x000000FF
#define BULLET_CONTACT_MASK 0x000000F0
#define BULLET_COLLISION_MASK 0x000000F0
...
#define BLOCK_CONTACT_MASK 0x000000F0
